...
from src.bot.keyboards.hubstaff import menu_keyboards, activities_keyboards
from src.bot.keyboards.hubstaff.activities_keyboards import WorkLogKeyboards
from src.bot.keyboards.hubstaff.menu_keyboards import MenuKeyboards
